...
if start_from0==1: #if starting from a previous time step
    ...
    h1_pickup=xr.open_dataset("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/h1_xr_control_years375to450_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
    h2_pickup=xr.open_dataset("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/h2_xr_control_years375to450_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
    u1_pickup=xr.open_dataset("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/u1_xr_control_years375to450_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
    u2_pickup=xr.open_dataset("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/u2_xr_control_years375to450_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
    v1_pickup=xr.open_dataset("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/v1_xr_control_years375to450_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
    v2_pickup=xr.open_dataset("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/v2_xr_control_years375to450_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
...
from model import *
import_initialvalues(dt, t, _u1,_v1,_h1,_h2,_u2, _v2, ny,dx,dy,tau_min,tau_max,H1,H2,nu,r,tau_x,f0,beta,rho1,rho2,rho3,uy,vy,m1o=0,m2o=0,extento=5)
nsteps = 9331200
...
h1_xr.to_netcdf("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/h1_xr_control_years450to525_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
h2_xr.to_netcdf("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/h2_xr_control_years450to525_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
u1_xr.to_netcdf("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/u1_xr_control_years450to525_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
u2_xr.to_netcdf("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/u2_xr_control_years450to525_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
v1_xr.to_netcdf("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/v1_xr_control_years450to525_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")
v2_xr.to_netcdf("/scratch/abf376/2.5_layer_model/main_2.5layer/output_files/v2_xr_control_years450to525_control_wind_fix_northofsponge_nohdamp_sealevel_tunedtomitgcm_nu8e3_dt250_rk4_nohdiffusion_noslip_properimplement_update_onlycorners_nonlinear_H1_250_H2_250_delta_rho2_mitdomainsize_mod.nc")